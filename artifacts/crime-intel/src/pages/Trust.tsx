...
import { mockLedgerStatus, mockAccessLog } from '../mockData';
...
export function TrustOversight() {
  ...
  const ledger = (ledgerData && (ledgerData as any).state) ? ledgerData : mockLedgerStatus;
  const logs = Array.isArray(logsData) ? logsData : mockAccessLog;
