...
import { mockHotspots, mockDistricts } from '../mockData';
...
export function HotspotMap() {
  ...
  const hotspots = Array.isArray(hotspotData) ? hotspotData : mockHotspots;
  const districts = Array.isArray(districtData) ? districtData : mockDistricts;
