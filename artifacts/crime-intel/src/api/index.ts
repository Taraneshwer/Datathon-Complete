import { mockCases, mockDistricts, mockHotspots, mockAlerts, mockDashboardAnalytics, mockAccessLog, mockLedgerStatus, mockPatterns, mockNodes, mockEdges, mockTimeline, mockEvidence, mockBiasAudit, mockSuspects, mockVictims } from '../mockData';
import { 
...
// So I don't need to intercept here, I just use the hooks from @workspace/api-client-react.
...
// BUT it also says: "API HOOKS — import from @workspace/api-client-react... Available hooks (use ALL of them throughout the app)... The backend will serve real mock data from these endpoints. Wire the hooks to the backend (not to mockData directly from components)"
...
// I will import from `@workspace/api-client-react` in components directly as instructed.
...
// To be safe, I'll use the generated hooks from @workspace/api-client-react.
